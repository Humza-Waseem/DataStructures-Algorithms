...
# driver = webdriver.Chrome(executable_path='C:\Users\sheik\anaconda3\chromedriver-win64\chromedriver.exe')
# driver = webdriver.Chrome(executable_path=r'C:\\Users\\sheik\\anaconda3\\chromedriver-win64\\chromedriver.exe')
driver = webdriver.Chrome(executable_path='C:\\Users\\sheik\\anaconda3\\chromedriver-win64\\chromedriver.exe')
